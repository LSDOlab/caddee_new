...
rlo_chord_cps = caddee_csdl_model.create_input('rlo_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rlo_twist_cps = caddee_csdl_model.create_input('rlo_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
rli_chord_cps = caddee_csdl_model.create_input('rli_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rli_twist_cps = caddee_csdl_model.create_input('rli_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
rri_chord_cps = caddee_csdl_model.create_input('rri_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rri_twist_cps = caddee_csdl_model.create_input('rri_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
rro_chord_cps = caddee_csdl_model.create_input('rro_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rro_twist_cps = caddee_csdl_model.create_input('rro_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
flo_chord_cps = caddee_csdl_model.create_input('flo_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
flo_twist_cps = caddee_csdl_model.create_input('flo_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
fro_chord_cps = caddee_csdl_model.create_input('fro_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
fro_twist_cps = caddee_csdl_model.create_input('fro_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
fli_radius = caddee_csdl_model.create_input('fli_radius', val=5)
...
fli_chord_cps = caddee_csdl_model.create_input('fli_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
fli_twist_cps = caddee_csdl_model.create_input('fli_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
...
fri_radius = caddee_csdl_model.create_input('fri_radius', val=5)
...
fri_chord_cps = caddee_csdl_model.create_input('fri_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
fri_twist_cps = caddee_csdl_model.create_input('fri_blade_1_twist', val=np.deg2rad(np.linspace(40, 10, 5)))
