...
# rlo_bem_model = BEM(disk_prefix='qst_1_rlo_disk', blade_prefix='rlo', component=rlo_disk, mesh=bem_mesh_lift)
# rlo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rlo_bem_forces, rlo_bem_moments,_ ,_ ,_ ,_  = rlo_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# rli_bem_model = BEM(disk_prefix='qst_1_rli_disk', blade_prefix='rli', component=rli_disk, mesh=bem_mesh_lift)
# rli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rli_bem_forces, rli_bem_moments,_ ,_ ,_ ,_ = rli_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# rri_bem_model = BEM(disk_prefix='qst_1_rri_disk', blade_prefix='rri', component=rri_disk, mesh=bem_mesh_lift)
# rri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rri_bem_forces, rri_bem_moments,_ ,_ ,_ ,_ = rri_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# rro_bem_model = BEM(disk_prefix='qst_1_rro_disk', blade_prefix='rro', component=rro_disk, mesh=bem_mesh_lift)
# rro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rro_bem_forces, rro_bem_moments,_ ,_ ,_ ,_ = rro_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# flo_bem_model = BEM(disk_prefix='qst_1_flo_disk', blade_prefix='flo', component=flo_disk, mesh=bem_mesh_lift)
# flo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# flo_bem_forces, flo_bem_moments,_ ,_ ,_, _= flo_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# fli_bem_model = BEM(disk_prefix='qst_1_fli_disk', blade_prefix='fli', component=fli_disk, mesh=bem_mesh_lift)
# fli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fli_bem_forces, fli_bem_moments,_ ,_ ,_ ,_ = fli_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# fri_bem_model = BEM(disk_prefix='qst_1_fri_disk', blade_prefix='fri', component=fri_disk, mesh=bem_mesh_lift)
# fri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fri_bem_forces, fri_bem_moments,_ ,_ ,_ ,_ = fri_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)

# fro_bem_model = BEM(disk_prefix='qst_1_fro_disk', blade_prefix='fro', component=fro_disk, mesh=bem_mesh_lift)
# fro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fro_bem_forces, fro_bem_moments,_ ,_ ,_ ,_ = fro_bem_model.evaluate(ac_states=qst_1_ac_states, design_condition=qst_1)
...
# rlo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rlo_bem_forces, rlo_bem_moments,_ ,_ ,_, _ = rlo_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# rli_bem_model = PittPeters(disk_prefix='qst_2_rli_disk', blade_prefix='rli', component=rli_disk, mesh=pitt_peters_mesh_lift)
# rli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rli_bem_forces, rli_bem_moments,_ ,_ ,_, _ = rli_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# rri_bem_model = PittPeters(disk_prefix='qst_2_rri_disk', blade_prefix='rri', component=rri_disk, mesh=pitt_peters_mesh_lift)
# rri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rri_bem_forces, rri_bem_moments,_ ,_ ,_, _ = rri_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# rro_bem_model = PittPeters(disk_prefix='qst_2_rro_disk', blade_prefix='rro', component=rro_disk, mesh=pitt_peters_mesh_lift)
# rro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# rro_bem_forces, rro_bem_moments,_ ,_ ,_, _ = rro_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# flo_bem_model = PittPeters(disk_prefix='qst_2_flo_disk', blade_prefix='flo', component=flo_disk, mesh=pitt_peters_mesh_lift)
# flo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# flo_bem_forces, flo_bem_moments,_ ,_ ,_, _ = flo_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# fli_bem_model = PittPeters(disk_prefix='qst_2_fli_disk', blade_prefix='fli', component=fli_disk, mesh=pitt_peters_mesh_lift)
# fli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fli_bem_forces, fli_bem_moments,_ ,_ ,_, _ = fli_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# fri_bem_model = PittPeters(disk_prefix='qst_2_fri_disk', blade_prefix='fri', component=fri_disk, mesh=pitt_peters_mesh_lift)
# fri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fri_bem_forces, fri_bem_moments,_ ,_ ,_, _ = fri_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)

# fro_bem_model = PittPeters(disk_prefix='qst_2_fro_disk', blade_prefix='fro', component=fro_disk, mesh=pitt_peters_mesh_lift)
# fro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=500, upper=4000, scaler=1e-3)
# fro_bem_forces, fro_bem_moments,_ ,_ ,_, _ = fro_bem_model.evaluate(ac_states=qst_2_ac_states, design_condition=qst_2)
...
# rlo_bem_forces, rlo_bem_moments,_ ,_ ,_, _ = rlo_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# rli_bem_forces, rli_bem_moments,_ ,_ ,_, _ = rli_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# rri_bem_forces, rri_bem_moments,_ ,_ ,_, _ = rri_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# rro_bem_forces, rro_bem_moments,_ ,_ ,_, _ = rro_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# flo_bem_forces, flo_bem_moments,_ ,_ ,_, _ = flo_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# fli_bem_forces, fli_bem_moments,_ ,_ ,_, _ = fli_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# fri_bem_forces, fri_bem_moments,_ ,_ ,_, _ = fri_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# fro_bem_forces, fro_bem_moments,_ ,_ ,_, _ = fro_bem_model.evaluate(ac_states=qst_3_ac_states, design_condition=qst_3)
...
# rlo_bem_forces, rlo_bem_moments,_ ,_ ,_, _ = rlo_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# rli_bem_forces, rli_bem_moments,_ ,_ ,_, _ = rli_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# rri_bem_forces, rri_bem_moments,_ ,_ ,_, _ = rri_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# rro_bem_forces, rro_bem_moments,_ ,_ ,_, _ = rro_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# flo_bem_forces, flo_bem_moments,_ ,_ ,_, _ = flo_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# fli_bem_forces, fli_bem_moments,_ ,_ ,_, _ = fli_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# fri_bem_forces, fri_bem_moments,_ ,_ ,_, _ = fri_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# fro_bem_forces, fro_bem_moments,_ ,_ ,_, _ = fro_bem_model.evaluate(ac_states=qst_4_ac_states, design_condition=qst_4)
...
# rlo_bem_model = PittPeters(disk_prefix='rlo_disk', blade_prefix='rlo', component=rlo_disk, mesh=pitt_peters_mesh_lift)
# rlo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# rlo_bem_forces, rlo_bem_moments,_ ,_ ,_, _ = rlo_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# rli_bem_model = PittPeters(disk_prefix='rli_disk', blade_prefix='rli', component=rli_disk, mesh=pitt_peters_mesh_lift)
# rli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# rli_bem_forces, rli_bem_moments,_ ,_ ,_, _ = rli_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# rri_bem_model = PittPeters(disk_prefix='rri_disk', blade_prefix='rri', component=rri_disk, mesh=pitt_peters_mesh_lift)
# rri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# rri_bem_forces, rri_bem_moments,_ ,_ ,_, _ = rri_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# rro_bem_model = PittPeters(disk_prefix='rro_disk', blade_prefix='rro', component=rro_disk, mesh=pitt_peters_mesh_lift)
# rro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# rro_bem_forces, rro_bem_moments,_ ,_ ,_, _ = rro_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# flo_bem_model = PittPeters(disk_prefix='flo_disk', blade_prefix='flo', component=flo_disk, mesh=pitt_peters_mesh_lift)
# flo_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# flo_bem_forces, flo_bem_moments,_ ,_ ,_, _ = flo_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# fli_bem_model = PittPeters(disk_prefix='fli_disk', blade_prefix='fli', component=fli_disk, mesh=pitt_peters_mesh_lift)
# fli_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# fli_bem_forces, fli_bem_moments,_ ,_ ,_, _ = fli_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# fri_bem_model = PittPeters(disk_prefix='fri_disk', blade_prefix='fri', component=fri_disk, mesh=pitt_peters_mesh_lift)
# fri_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# fri_bem_forces, fri_bem_moments,_ ,_ ,_, _ = fri_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)

# fro_bem_model = PittPeters(disk_prefix='fro_disk', blade_prefix='fro', component=fro_disk, mesh=pitt_peters_mesh_lift)
# fro_bem_model.set_module_input('rpm', val=1350, dv_flag=True, lower=5, upper=4000, scaler=1e-3)
# fro_bem_forces, fro_bem_moments,_ ,_ ,_, _ = fro_bem_model.evaluate(ac_states=qst_5_ac_states, design_condition=qst_5)
...
rlo_radius = caddee_csdl_model.create_input('rlo_radius', val=5)
...
rlo_chord_cps_1 = caddee_csdl_model.create_input('rlo_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rlo_twist_cps_1 = caddee_csdl_model.create_input('rlo_blade_1_twist', val=np.zeros((5, )))
rlo_chord_cps_2 = caddee_csdl_model.create_input('rlo_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
rlo_twist_cps_2 = caddee_csdl_model.create_input('rlo_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('rlo_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('rlo_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rlo_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('rlo_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rlo_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('rlo_blade_chord_equality', rlo_chord_cps_1-rlo_chord_cps_2)
caddee_csdl_model.register_output('rlo_blade_twist_equality', rlo_twist_cps_1-rlo_twist_cps_2)
caddee_csdl_model.add_constraint('rlo_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('rlo_blade_twist_equality', equals=0)

rli_radius = caddee_csdl_model.create_input('rli_radius', val=5)
caddee_csdl_model.connect('rli_radius', 'rli_in_plane_r1')
caddee_csdl_model.connect('rli_radius', 'rli_in_plane_r2')
caddee_csdl_model.connect('rli_radius', 'rli_in_plane_r3')
caddee_csdl_model.connect('rli_radius', 'rli_in_plane_r4')
rli_chord_cps_1 = caddee_csdl_model.create_input('rli_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
# rli_twist_cps_1 = caddee_csdl_model.create_input('rli_blade_1_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
rli_twist_cps_1 = caddee_csdl_model.create_input('rli_blade_1_twist', val=np.zeros((5, )))
rli_chord_cps_2 = caddee_csdl_model.create_input('rli_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
# rli_twist_cps_2 = caddee_csdl_model.create_input('rli_blade_2_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
rli_twist_cps_2 = caddee_csdl_model.create_input('rli_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('rli_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('rli_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rli_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('rli_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rli_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('rli_blade_chord_equality', rli_chord_cps_1-rli_chord_cps_2)
caddee_csdl_model.register_output('rli_blade_twist_equality', rli_twist_cps_1-rli_twist_cps_2)
caddee_csdl_model.add_constraint('rli_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('rli_blade_twist_equality', equals=0)


rri_radius = caddee_csdl_model.create_input('rri_radius', val=5)
caddee_csdl_model.connect('rri_radius', 'rri_in_plane_r1')
caddee_csdl_model.connect('rri_radius', 'rri_in_plane_r2')
caddee_csdl_model.connect('rri_radius', 'rri_in_plane_r3')
caddee_csdl_model.connect('rri_radius', 'rri_in_plane_r4')
rri_chord_cps_1 = caddee_csdl_model.create_input('rri_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rri_twist_cps_1 = caddee_csdl_model.create_input('rri_blade_1_twist', val=np.zeros((5, )))
rri_chord_cps_2 = caddee_csdl_model.create_input('rri_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
rri_twist_cps_2 = caddee_csdl_model.create_input('rri_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('rri_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('rri_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rri_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('rri_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rri_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('rri_blade_chord_equality', rri_chord_cps_1-rri_chord_cps_2)
caddee_csdl_model.register_output('rri_blade_twist_equality', rri_twist_cps_1-rri_twist_cps_2)
caddee_csdl_model.add_constraint('rri_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('rri_blade_twist_equality', equals=0)


rro_radius = caddee_csdl_model.create_input('rro_radius', val=5)
caddee_csdl_model.connect('rro_radius', 'rro_in_plane_r1')
caddee_csdl_model.connect('rro_radius', 'rro_in_plane_r2')
caddee_csdl_model.connect('rro_radius', 'rro_in_plane_r3')
caddee_csdl_model.connect('rro_radius', 'rro_in_plane_r4')
rro_chord_cps_1 = caddee_csdl_model.create_input('rro_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
rro_twist_cps_1 = caddee_csdl_model.create_input('rro_blade_1_twist', val=np.zeros((5, )))
# rro_twist_cps_1 = caddee_csdl_model.create_input('rro_blade_1_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
rro_chord_cps_2 = caddee_csdl_model.create_input('rro_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
rro_twist_cps_2 = caddee_csdl_model.create_input('rro_blade_2_twist', val=np.zeros((5, )))
# rro_twist_cps_2 = caddee_csdl_model.create_input('rro_blade_2_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
caddee_csdl_model.add_design_variable('rro_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('rro_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rro_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('rro_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('rro_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('rro_blade_chord_equality', rro_chord_cps_1-rro_chord_cps_2)
caddee_csdl_model.register_output('rro_blade_twist_equality', rro_twist_cps_1-rro_twist_cps_2)
caddee_csdl_model.add_constraint('rro_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('rro_blade_twist_equality', equals=0)


flo_radius = caddee_csdl_model.create_input('flo_radius', val=5)
caddee_csdl_model.connect('flo_radius', 'flo_in_plane_r1')
caddee_csdl_model.connect('flo_radius', 'flo_in_plane_r2')
caddee_csdl_model.connect('flo_radius', 'flo_in_plane_r3')
caddee_csdl_model.connect('flo_radius', 'flo_in_plane_r4')
flo_chord_cps_1 = caddee_csdl_model.create_input('flo_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
# flo_twist_cps_1 = caddee_csdl_model.create_input('flo_blade_1_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
flo_twist_cps_1 = caddee_csdl_model.create_input('flo_blade_1_twist', val=np.zeros((5, )))
flo_chord_cps_2 = caddee_csdl_model.create_input('flo_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
# flo_twist_cps_2 = caddee_csdl_model.create_input('flo_blade_2_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
flo_twist_cps_2 = caddee_csdl_model.create_input('flo_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('flo_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('flo_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('flo_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('flo_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('flo_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('flo_blade_chord_equality', flo_chord_cps_1-flo_chord_cps_2)
caddee_csdl_model.register_output('flo_blade_twist_equality', flo_twist_cps_1-flo_twist_cps_2)
caddee_csdl_model.add_constraint('flo_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('flo_blade_twist_equality', equals=0)


fro_radius = caddee_csdl_model.create_input('fro_radius', val=5)
caddee_csdl_model.connect('fro_radius', 'fro_in_plane_r1')
caddee_csdl_model.connect('fro_radius', 'fro_in_plane_r2')
caddee_csdl_model.connect('fro_radius', 'fro_in_plane_r3')
caddee_csdl_model.connect('fro_radius', 'fro_in_plane_r4')
fro_chord_cps_1 = caddee_csdl_model.create_input('fro_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
fro_twist_cps_1 = caddee_csdl_model.create_input('fro_blade_1_twist', val=np.zeros((5, )))
fro_chord_cps_2 = caddee_csdl_model.create_input('fro_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
fro_twist_cps_2 = caddee_csdl_model.create_input('fro_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('fro_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('fro_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fro_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('fro_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fro_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('fro_blade_chord_equality', fro_chord_cps_1-fro_chord_cps_2)
caddee_csdl_model.register_output('fro_blade_twist_equality', fro_twist_cps_1-fro_twist_cps_2)
caddee_csdl_model.add_constraint('fro_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('fro_blade_twist_equality', equals=0)


fli_radius = caddee_csdl_model.create_input('fli_radius', val=2.5)
caddee_csdl_model.connect('fli_radius', 'fli_in_plane_r1')
caddee_csdl_model.connect('fli_radius', 'fli_in_plane_r2')
caddee_csdl_model.connect('fli_radius', 'fli_in_plane_r3')
caddee_csdl_model.connect('fli_radius', 'fli_in_plane_r4')
fli_chord_cps_1 = caddee_csdl_model.create_input('fli_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
fli_twist_cps_1 = caddee_csdl_model.create_input('fli_blade_1_twist', val=np.zeros((5, )))
fli_chord_cps_2 = caddee_csdl_model.create_input('fli_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
fli_twist_cps_2 = caddee_csdl_model.create_input('fli_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('fli_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('fli_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fli_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('fli_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fli_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('fli_blade_chord_equality', fli_chord_cps_1-fli_chord_cps_2)
caddee_csdl_model.register_output('fli_blade_twist_equality', fli_twist_cps_1-fli_twist_cps_2)
caddee_csdl_model.add_constraint('fli_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('fli_blade_twist_equality', equals=0)


fri_radius = caddee_csdl_model.create_input('fri_radius', val=2.5)
caddee_csdl_model.connect('fri_radius', 'fri_in_plane_r1')
caddee_csdl_model.connect('fri_radius', 'fri_in_plane_r2')
caddee_csdl_model.connect('fri_radius', 'fri_in_plane_r3')
caddee_csdl_model.connect('fri_radius', 'fri_in_plane_r4')
fri_chord_cps_1 = caddee_csdl_model.create_input('fri_blade_1_chord', val=np.linspace(0.3, 0.1, 4))
# fri_twist_cps_1 = caddee_csdl_model.create_input('fri_blade_1_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
fri_twist_cps_1 = caddee_csdl_model.create_input('fri_blade_1_twist', val=np.zeros((5, )))
fri_chord_cps_2 = caddee_csdl_model.create_input('fri_blade_2_chord', val=np.linspace(0.3, 0.1, 4))
# fri_twist_cps_2 = caddee_csdl_model.create_input('fri_blade_2_twist', val=np.deg2rad(np.linspace(50, 20, 5)))
fri_twist_cps_2 = caddee_csdl_model.create_input('fri_blade_2_twist', val=np.zeros((5, )))
caddee_csdl_model.add_design_variable('fri_radius', lower=3, upper=7, scaler=1e-1)
caddee_csdl_model.add_design_variable('fri_blade_2_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fri_blade_2_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.add_design_variable('fri_blade_1_chord', lower=0.05, upper=0.4)
caddee_csdl_model.add_design_variable('fri_blade_1_twist', lower=np.deg2rad(1), upper=np.deg2rad(70))
caddee_csdl_model.register_output('fri_blade_chord_equality', fri_chord_cps_1-fri_chord_cps_2)
caddee_csdl_model.register_output('fri_blade_twist_equality', fri_twist_cps_1-fri_twist_cps_2)
caddee_csdl_model.add_constraint('fri_blade_chord_equality', equals=0)
caddee_csdl_model.add_constraint('fri_blade_twist_equality', equals=0)


front_radii_outer_constraint = caddee_csdl_model.register_output('front_radii_outer_constraint', fro_radius-flo_radius)
front_radii_inner_constraint = caddee_csdl_model.register_output('front_radii_inner_constraint', fri_radius-fli_radius)
rear_radii_outer_constraint = caddee_csdl_model.register_output('rear_radii_outer_constraint', rro_radius-rlo_radius)
rear_radii_inner_constraint = caddee_csdl_model.register_output('rear_radii_inner_constraint', rri_radius-rli_radius)
caddee_csdl_model.add_constraint('front_radii_outer_constraint', equals=0, scaler=1e-1)
caddee_csdl_model.add_constraint('front_radii_inner_constraint', equals=0, scaler=1e-1)
caddee_csdl_model.add_constraint('rear_radii_outer_constraint', equals=0, scaler=1e-1)
caddee_csdl_model.add_constraint('rear_radii_inner_constraint', equals=0, scaler=1e-1)



wing_span = caddee_csdl_model.create_input('wing_span', val=50)
tail_span = caddee_csdl_model.create_input('tail_span', val=13)
caddee_csdl_model.add_design_variable('wing_span', lower=30, upper=70, scaler=1e-3)
caddee_csdl_model.add_design_variable('tail_span', lower=5, upper=30, scaler=4e-2)
...
# caddee_csdl_model.add_constraint('system_model.system_m3l_model.total_noise_model.A_weighted_total_spl', upper=72, scaler=1e-2)
