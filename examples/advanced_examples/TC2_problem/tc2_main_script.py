...
import pickle
with open('quasi_isotropic_MDO_acoustics_75_db_90_m_dc.pickle', 'rb') as handle:
...
print('\n')
print('\n')
with open('quasi_isotropic_full_MDO_dvs_2.pickle', 'wb') as handle:
...
with open('quasi_isotropic_full_MDO_constraints_2.pickle', 'wb') as handle:
