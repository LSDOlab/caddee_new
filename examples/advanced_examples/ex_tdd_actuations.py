...
cruise_configuration.transform(name='cruise_tail_actutation', transformation=horizontal_stabilizer_actuator_solver)   # The representation's version of add_solver. CADDEE may or may not call this.
